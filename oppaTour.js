...
(function(){
  ...
  function showAll(){
    ...
    let url = "http://localhost:3000/?mode=all";
    fetch(url)
      .then(checkStatus)
  ...
  function afterSearch(){
    ...
    let url = "http://localhost:3000/?mode=none";
    if (language.value == "" && price.value == ""){
      ...
      if (language.value != "" && isNaN(price.value)==false){
        url = "http://localhost:3000/?mode=find&price=" + parseInt(price.value)
        + "&language=" + language.value;
      }
      //Find only matches languages
      else if (/^[a-zA-Z]+$/.test(language.value) && price.value == ""){
        url = "http://localhost:3000/?mode=find&language=" + language.value;
      }
  ...
  function guyInfo(folder){
    ...
    let urlInfo = "http://localhost:3000/?mode=info&folder="+folder;
    //let urlInfo = "http://localhost:3000/?notfound";
    let urlDes = "http://localhost:3000/?mode=description&folder="+folder;
    let urlCom = "http://localhost:3000/?mode=comments&folder="+folder;
