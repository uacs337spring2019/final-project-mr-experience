...
(function(){
  ...
  function showAll(){
    ...
    let url = "http://oppatour4ua.herokuapp.com:"  + "/?mode=all";
    fetch(url)
      .then(checkStatus)
  ...
  function afterSearch(){
    ...
    let url = "http://oppatour4ua.herokuapp.com:"  + "/?mode=none";
    if (language.value == "" && price.value == ""){
      ...
      if (language.value != "" && isNaN(price.value)==false){
        url = "http://oppatour4ua.herokuapp.com:"  + "/?mode=find&price=" + parseInt(price.value)
        + "&language=" + language.value;
      }
      //Find only matches languages
      else if (/^[a-zA-Z]+$/.test(language.value) && price.value == ""){
        url = "http://oppatour4ua.herokuapp.com:"  + "/?mode=find&language=" + language.value;
      }
  ...
  function writeComments(folder){
    ...
    if (cDate.value == ""){
      ...
      let url = "http://oppatour4ua.herokuapp.com:" ;
  ...
  function guyInfo(folder){
    ...
    let urlInfo = "http://oppatour4ua.herokuapp.com:"  + "/?mode=info&folder="+folder;
    //let urlInfo = "http://localhost:3000/?notfound";
    let urlDes = "http://oppatour4ua.herokuapp.com:"  + "/?mode=description&folder="+folder;
    let urlCom = "http://oppatour4ua.herokuapp.com:"  + "/?mode=comments&folder="+folder;
